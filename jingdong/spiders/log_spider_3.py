...
def get_spids():
    ...
    """
    # ttk_show日志本地存储路径
    path = '/tmp/ttk_shown/ttk_shown_3'
    ...
    # 获取昨天2, 6, 10, 14, 18, 22点共6个小时的ttk_shown日志
    for hour in xrange(2, 24, 4):
...
class LogSpider3(scrapy.Spider):
    name = "log_spider_3"
    start_urls = []
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(LogSpider3, cls).from_crawler(crawler, *args, **kwargs)
