...
def get_spids():
    ...
    """
    # ttk_show日志本地存储路径
    path = '/tmp/ttk_shown/ttk_shown_2'
    ...
    # 获取昨天1, 5, 9, 13, 17, 21点共6个小时的ttk_shown日志
    for hour in xrange(1, 24, 4):
...
class LogSpider2(scrapy.Spider):
    name = "log_spider_2"
    start_urls = []
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(LogSpider2, cls).from_crawler(crawler, *args, **kwargs)
