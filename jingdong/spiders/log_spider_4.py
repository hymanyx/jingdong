...
def get_spids():
    ...
    """
    # ttk_show日志本地存储路径
    path = '/tmp/ttk_shown/ttk_shown_4'
    ...
    # 获取昨天3, 7, 11, 15, 19, 23点共6个小时的ttk_shown日志
    for hour in xrange(3, 24, 4):
...
class LogSpider4(scrapy.Spider):
    name = "log_spider_4"
    start_urls = []
    ...
    def from_crawler(cls, crawler, *args, **kwargs):
        spider = super(LogSpider4, cls).from_crawler(crawler, *args, **kwargs)
